...
uint256 hashGenesisBlock("0x56c0ae75417db96f2bbfdd25c4c52c595ffc529b3e0bff11df26e83836da5e82");
...
{
    // Altcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetSpacing = 2.5 * 60; // Altcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Altcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Altcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Altcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x56c0ae75417db96f2bbfdd25c4c52c595ffc529b3e0bff11df26e83836da5e82");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "First day of altcoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1479798853;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1183402;
        ...
        assert(block.hashMerkleRoot == uint256("0x468c65680273e3c7fcfb5465b6d9e6a5bb239b31d5ba6b8821b93c42324bfba0"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Altcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AltcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AltcoinMiner : ProcessBlock, block not accepted");
    }
